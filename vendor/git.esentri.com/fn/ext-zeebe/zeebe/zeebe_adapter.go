...
func (zeebeAdapter *ZeebeAdapter) RegisterFunctionAsWorker() {
	...
	zeebeAdapter.instance = client.NewJobWorker().JobType(jobType).Handler(handleJob).Open()
}

func (zeebeAdapter *ZeebeAdapter) UnregisterFunctionAsWorker() {
